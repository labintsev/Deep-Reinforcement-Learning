...
if __name__ == "__main__":
    ...
    exp_source = lib.experience.ExperienceSourceFirstLast(envs, agent, gamma=GAMMA, steps_count=REWARD_STEPS)

    optimizer = optim.Adam(net.parameters(), lr=LEARNING_RATE, eps=1e-3)

    batch = []

    with lib.common.RewardTracker(writer, stop_reward=18) as tracker:
        with lib.utils.TBMeanTracker(writer, batch_size=10) as tb_tracker:
